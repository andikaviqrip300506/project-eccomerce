<template>
  ...
  <div class="absolute -top-10 left-1/2 h-16 w-16 -translate-x-1/2 rounded-xl border-4 border-indigo-500 bg-white p-2"><img class="h-full object-contain" src="../assets/image/a.png" alt="" /></div>
  ...
  <p class="py-10 text-center text-gray-300">© 2023 Andikaa | All Rights Reserved</p>
</footer>
