<template>
  ...
  <div class="container mx-auto px-4">
    ...
    <div class="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
        ...
        <div class="lg:flex lg:items-start">
          <div class="lg:order-2 lg:ml-5">
            <div class="max-w-xl overflow-hidden rounded-lg">
              <img class="h-full w-full max-w-full object-cover" src="../assets/image/scmm4.webp" alt="" />
            </div>
          </div>
          ...
          <div class="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
            <div class="flex flex-row items-start lg:flex-col">
              <button type="button" class="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-gray-900 text-center">
                <img class="h-full w-full object-cover" src="../assets/image/scmm4.webp" alt="" />
              </button>
      ...
      <div class="lg:col-span-2 lg:row-span-2 lg:row-end-2 lg:mt" >
        ...
        <h2 class="mt-8 text-base text-gray-900">Choose Quantity</h2>
        <div class="class= grid md:grid-cols-3 mb-3 mt-3">
                            <div class="flex items-center border-gray-100">
                                <!-- Counter Item -->
                                <span @click="kurang"
                                    class="cursor-pointer rounded-l bg-black py-1 px-3.5 duration-100 hover:bg-gray hover:text-white">
                                    <font color="white"> - </font></span>
                                <span class="mr-2 ml-2">
                                    {{ cek }}
                                </span>
                                <span @click="tambah"
                                    class="cursor-pointer rounded-r bg-black py-1 px-3 duration-100 hover:bg-black hover:text-yellow-50">
                                   <font color="white"> + </font></span>
                            </div>
                            </div>
        ...
        <div class="mt-10 flex flex-col items-center justify-between space-y-4 border-t border-b py-4 sm:flex-row sm:space-y-0">
          ...
          <div v-if="token">
            <router-link to="/cart">
            <button @click="addToCart(getProductId.id)" type="button" class="inline-flex items-center justify-center rounded-md border-2 border-transparent bg-gray-900 bg-none px-12 py-3 text-center text-base font-bold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-gray-800">
